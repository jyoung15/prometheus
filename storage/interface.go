...
// QuerierFunc is an adapter to allow the use of ordinary functions as Queriers.
// It follows the idea of http.HandlerFunc.
type QuerierFunc func(ctx context.Context, mint, maxt int64) (Querier, error)

// Querier calls f() with the given parameters.
func (f QuerierFunc) Querier(ctx context.Context, mint, maxt int64) (Querier, error) {
